"use strict";
// let message: (string | number | boolean) = "Welcome Nafisa, hehe its me";
// message = 555;
//alert(message);
//let message : any = "hehe it me Nafisa";
//alert(message);
// let message:Array<string> = ["Nafisa Array","Ohh Doodles","Nice me"]
